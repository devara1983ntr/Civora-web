...
const RestInfo = () => {
  ...
  return (
    <div className='w-screen h-auto'>
      <Heading
        heading={t("reach_more_customers_and_grow_your_business_with_Civora")}
        subHeading={t("partner_with_Civora_to_create_more_sales")}
      />
      <StartingImage image={restaurantBanner} />
      <WhyChoose
        heading={t("why_deliver_with_Civora")}
